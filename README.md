...
1. The master source of truth is [victor_sterling_financial_project_continuation_brief.md](victor_sterling_financial_project_continuation_brief.md).
2. The supporting constitutional knowledge base lives in [Brains/README.md](Brains/README.md) and the five physician-finance books in `Brains/`.
...
- A browser-based intake/triage artifact exists in [victor_sterling_financial_advisor_ARTIFACT_v3.html](victor_sterling_financial_advisor_ARTIFACT_v3.html).
- A spreadsheet-first workflow spec lives in [VICTOR_WORKBOOK_SPEC.md](docs/product/VICTOR_WORKBOOK_SPEC.md), and the workbook can be generated from `scripts/create_victor_workbook.py`.
- A markdown interpretation layer for the workbook lives in [docs/playbooks/README.md](docs/playbooks/README.md).
